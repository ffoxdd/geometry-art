#ifndef GLOBEART_SRC_GLOBE_IO_SNAPSHOT_SVG_WRITER_HPP_
#define GLOBEART_SRC_GLOBE_IO_SNAPSHOT_SVG_WRITER_HPP_
...
#endif //GLOBEART_SRC_GLOBE_IO_SNAPSHOT_SVG_WRITER_HPP_
