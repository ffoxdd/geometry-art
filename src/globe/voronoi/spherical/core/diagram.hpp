#ifndef GLOBEART_SRC_GLOBE_VORONOI_SPHERICAL_CORE_DIAGRAM_HPP_
#define GLOBEART_SRC_GLOBE_VORONOI_SPHERICAL_CORE_DIAGRAM_HPP_
...
#endif //GLOBEART_SRC_GLOBE_VORONOI_SPHERICAL_CORE_DIAGRAM_HPP_
