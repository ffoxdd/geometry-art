#ifndef GLOBEART_SRC_GLOBE_VORONOI_FLAT_OPTIMIZERS_CVT_HESSIAN_HPP_
#define GLOBEART_SRC_GLOBE_VORONOI_FLAT_OPTIMIZERS_CVT_HESSIAN_HPP_
...
#endif //GLOBEART_SRC_GLOBE_VORONOI_FLAT_OPTIMIZERS_CVT_HESSIAN_HPP_
