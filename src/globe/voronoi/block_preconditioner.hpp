#ifndef GLOBEART_SRC_GLOBE_VORONOI_BLOCK_PRECONDITIONER_HPP_
#define GLOBEART_SRC_GLOBE_VORONOI_BLOCK_PRECONDITIONER_HPP_
...
#endif //GLOBEART_SRC_GLOBE_VORONOI_BLOCK_PRECONDITIONER_HPP_
