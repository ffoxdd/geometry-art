#ifndef GLOBEART_SRC_GLOBE_GEOMETRY_PLANAR_PERIODIC_DELAUNAY_HPP_
#define GLOBEART_SRC_GLOBE_GEOMETRY_PLANAR_PERIODIC_DELAUNAY_HPP_
...
#endif //GLOBEART_SRC_GLOBE_GEOMETRY_PLANAR_PERIODIC_DELAUNAY_HPP_
