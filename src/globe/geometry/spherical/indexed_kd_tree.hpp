#ifndef GLOBEART_SRC_GLOBE_GEOMETRY_SPHERICAL_INDEXED_KD_TREE_HPP_
#define GLOBEART_SRC_GLOBE_GEOMETRY_SPHERICAL_INDEXED_KD_TREE_HPP_
...
#endif //GLOBEART_SRC_GLOBE_GEOMETRY_SPHERICAL_INDEXED_KD_TREE_HPP_
