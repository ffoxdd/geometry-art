#ifndef GLOBEART_SRC_GLOBE_STD_EXT_PARALLEL_FOR_HPP_
#define GLOBEART_SRC_GLOBE_STD_EXT_PARALLEL_FOR_HPP_
...
inline size_t configured_worker_count() {
    const char* override = std::getenv("GLOBE_THREADS");
...
#endif //GLOBEART_SRC_GLOBE_STD_EXT_PARALLEL_FOR_HPP_
