#ifndef GLOBEART_SRC_GLOBE_TESTING_CONTRACTS_DIAGRAM_CONTRACT_HPP_
#define GLOBEART_SRC_GLOBE_TESTING_CONTRACTS_DIAGRAM_CONTRACT_HPP_
...
namespace globe::testing::contracts {
...
#endif //GLOBEART_SRC_GLOBE_TESTING_CONTRACTS_DIAGRAM_CONTRACT_HPP_
