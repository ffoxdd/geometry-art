#ifndef GEOMETRY_ART_VORONOI_OPTIMIZER_PARAMETERS_HPP_
#define GEOMETRY_ART_VORONOI_OPTIMIZER_PARAMETERS_HPP_
...
#endif //GEOMETRY_ART_VORONOI_OPTIMIZER_PARAMETERS_HPP_
