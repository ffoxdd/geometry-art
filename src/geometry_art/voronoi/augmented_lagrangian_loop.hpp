#ifndef GEOMETRY_ART_VORONOI_AUGMENTED_LAGRANGIAN_LOOP_HPP_
#define GEOMETRY_ART_VORONOI_AUGMENTED_LAGRANGIAN_LOOP_HPP_
...
#endif //GEOMETRY_ART_VORONOI_AUGMENTED_LAGRANGIAN_LOOP_HPP_
