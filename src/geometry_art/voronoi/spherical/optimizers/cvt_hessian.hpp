#ifndef GEOMETRY_ART_VORONOI_SPHERICAL_OPTIMIZERS_CVT_HESSIAN_HPP_
#define GEOMETRY_ART_VORONOI_SPHERICAL_OPTIMIZERS_CVT_HESSIAN_HPP_
...
#endif //GEOMETRY_ART_VORONOI_SPHERICAL_OPTIMIZERS_CVT_HESSIAN_HPP_
