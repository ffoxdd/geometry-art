#ifndef GEOMETRY_ART_VORONOI_SPHERICAL_FACTORIES_FACTORY_HPP_
#define GEOMETRY_ART_VORONOI_SPHERICAL_FACTORIES_FACTORY_HPP_
...
class Factory {
 ...
 private:
    ...
    using SeededBoundingBoxSampler = geometry_art::UniformBoundingBoxSampler<geometry_art::UniformIntervalSampler>;
...
inline Factory::SeededPointGenerator Factory::seeded_point_generator(unsigned int seed) {
    return SeededPointGenerator(
        SeededCartesianGenerator(SeededBoundingBoxSampler(geometry_art::UniformIntervalSampler(seed))),
        geometry_art::UniformSphericalBoundingBoxSampler<>()
    );
}
...
#endif //GEOMETRY_ART_VORONOI_SPHERICAL_FACTORIES_FACTORY_HPP_
