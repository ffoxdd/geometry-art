#ifndef GEOMETRY_ART_VORONOI_FLAT_OPTIMIZERS_NEWTON_OPTIMIZER_HPP_
#define GEOMETRY_ART_VORONOI_FLAT_OPTIMIZERS_NEWTON_OPTIMIZER_HPP_
...
void NewtonOptimizer<FieldType>::Model::refresh_curvature() {
    _curvature.emplace(PreconditionedBlocks::of(_optimizer._hessian.assemble(*_optimizer._torus)));
}
...
#endif //GEOMETRY_ART_VORONOI_FLAT_OPTIMIZERS_NEWTON_OPTIMIZER_HPP_
