#ifndef GEOMETRY_ART_IO_SNAPSHOT_FLAT_SVG_WRITER_HPP_
#define GEOMETRY_ART_IO_SNAPSHOT_FLAT_SVG_WRITER_HPP_
...
#endif //GEOMETRY_ART_IO_SNAPSHOT_FLAT_SVG_WRITER_HPP_
