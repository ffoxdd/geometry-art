#ifndef GEOMETRY_ART_IO_MESH_VORONOI_SPHERE_WIREFRAME_BUILDER_HPP_
#define GEOMETRY_ART_IO_MESH_VORONOI_SPHERE_WIREFRAME_BUILDER_HPP_
...
#endif //GEOMETRY_ART_IO_MESH_VORONOI_SPHERE_WIREFRAME_BUILDER_HPP_
