#ifndef GEOMETRY_ART_TESTING_GOLDEN_FILE_HPP_
#define GEOMETRY_ART_TESTING_GOLDEN_FILE_HPP_
...
inline GoldenFile::GoldenFile(std::string relative_path) :
    _path(std::string(GEOMETRY_ART_SOURCE_DIR) + "/" + std::move(relative_path)) {
}
...
#endif //GEOMETRY_ART_TESTING_GOLDEN_FILE_HPP_
