#ifndef GEOMETRY_ART_GEOMETRY_SPHERICAL_ARC_HPP_
#define GEOMETRY_ART_GEOMETRY_SPHERICAL_ARC_HPP_
...
inline Moments Arc::moments(int max_degree) const {
    ...
    const auto& binomial = geometry_art::math::binomials(max_degree);
...
#endif //GEOMETRY_ART_GEOMETRY_SPHERICAL_ARC_HPP_
