#ifndef GEOMETRY_ART_GEOMETRY_SPHERICAL_BARYCENTRIC_HPP_
#define GEOMETRY_ART_GEOMETRY_SPHERICAL_BARYCENTRIC_HPP_
...
#endif //GEOMETRY_ART_GEOMETRY_SPHERICAL_BARYCENTRIC_HPP_
