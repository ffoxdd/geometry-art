#ifndef GEOMETRY_ART_GEOMETRY_SPHERICAL_BEZIER_TRIANGLE_HPP_
#define GEOMETRY_ART_GEOMETRY_SPHERICAL_BEZIER_TRIANGLE_HPP_
...
#endif //GEOMETRY_ART_GEOMETRY_SPHERICAL_BEZIER_TRIANGLE_HPP_
