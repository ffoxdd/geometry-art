#ifndef GEOMETRY_ART_GEOMETRY_SPHERICAL_TRIANGLE_MESH_HPP_
#define GEOMETRY_ART_GEOMETRY_SPHERICAL_TRIANGLE_MESH_HPP_
...
#endif //GEOMETRY_ART_GEOMETRY_SPHERICAL_TRIANGLE_MESH_HPP_
