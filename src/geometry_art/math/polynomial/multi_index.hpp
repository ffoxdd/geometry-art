#ifndef GEOMETRY_ART_MATH_POLYNOMIAL_MULTI_INDEX_HPP_
#define GEOMETRY_ART_MATH_POLYNOMIAL_MULTI_INDEX_HPP_
...
#endif //GEOMETRY_ART_MATH_POLYNOMIAL_MULTI_INDEX_HPP_
